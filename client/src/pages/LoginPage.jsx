  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <div className='flex flex-col justify-center items-center gap-10'>
        <img src={assets.nexusLogo} alt="" className='w-[min(30vw,250px)]'/>
        <h1 className='text-4xl font-bold text-gray-500'>NEXUSCHAT</h1>
      </div>

      {/* -------- right -------- */}

      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-gray-600 border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
